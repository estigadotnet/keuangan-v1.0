...
function MenuItem_Adding($item) {
	...
	// parameter link menu
	// agar form search selalu reset value nya

	if ($item->Url == 'r201_mutasismry.php') {
		$item->Url = 'r201_mutasismry.php?cmd=reset';
	}
	if ($item->Url == 'v202_jomutasihrnlist.php') {
		$item->Url = 'v202_jomutasihrnlist.php?cmd=reset';
	}
	if ($item->Url == 't001_jolist.php') {
		$item->Url = 't001_jolist.php?cmd=reset';
	}
	return TRUE;
}
