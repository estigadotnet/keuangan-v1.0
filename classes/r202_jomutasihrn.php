...
class r202_jomutasihrn
{
	...
	// Table name
	public $TableName = 'r202_jomutasihrn.php';

	// Page object name
	public $PageObjName = "r202_jomutasihrn";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'r202_jomutasihrn.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "r202_jomutasihrn", $url, "", "r202_jomutasihrn", TRUE);
		$this->Heading = $Language->TablePhrase("r202_jomutasihrn", "TblCaption"); 
	}
} // End class
?>