 ...
 * Page class
 */
class t101_saldoawal_list extends t101_saldoawal
{
	...
	// Table name
	public $TableName = 't101_saldoawal';

	// Page object name
	public $PageObjName = "t101_saldoawal_list";

	// Grid form hidden field names
	public $FormName = "ft101_saldoawallist";
	...
	public function __construct()
	{
		...
		// Table object (t101_saldoawal)
		if (!isset($GLOBALS["t101_saldoawal"]) || get_class($GLOBALS["t101_saldoawal"]) == PROJECT_NAMESPACE . "t101_saldoawal") {
			$GLOBALS["t101_saldoawal"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["t101_saldoawal"];
		}
		...
		$this->AddUrl = "t101_saldoawaladd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "t101_saldoawaldelete.php";
		$this->MultiUpdateUrl = "t101_saldoawalupdate.php";
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 't101_saldoawal');
		...
		$this->FilterOptions->TagClassName = "ew-filter-option ft101_saldoawallistsrch";
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"ft101_saldoawallistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = FALSE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"ft101_saldoawallistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = FALSE;
		...
		if (!$this->isGridAdd() && !$this->isGridEdit()) { // Not grid add/edit mode
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"#\" onclick=\"return ew.submitAction(event,jQuery.extend({f:document.ft101_saldoawallist}," . $listaction->toJson(TRUE) . "));\">" . $icon . "</a>";
	...
	protected function editRow()
	{
		...
		$conn = $this->getConnection();
		if ($this->Tanggal->CurrentValue != "") { // Check field with unique index
			$filterChk = "(`Tanggal` = '" . AdjustSql($this->Tanggal->CurrentValue, $this->Dbid) . "')";
			...
			if ($rsChk === FALSE) {
				...
				$idxErrMsg = str_replace("%f", $this->Tanggal->caption(), $Language->phrase("DupIndex"));
				$idxErrMsg = str_replace("%v", $this->Tanggal->CurrentValue, $idxErrMsg);
	...
	protected function addRow($rsold = NULL)
	{
		global $Language, $Security;
		if ($this->Tanggal->CurrentValue != "") { // Check field with unique index
			$filter = "(Tanggal = '" . AdjustSql($this->Tanggal->CurrentValue, $this->Dbid) . "')";
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.ft101_saldoawallist, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.ft101_saldoawallist, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.ft101_saldoawallist, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
			...
			return '<button id="emf_t101_saldoawal" class="ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" onclick="ew.emailDialogShow({lnk:\'emf_t101_saldoawal\', hdr:ew.language.phrase(\'ExportToEmailText\'), f:document.ft101_saldoawallist, sel:false' . $url . '});">' . $Language->phrase("ExportToEmail") . '</button>';
