...
/**
 * Table class for c201_mutasi
 */
class c201_mutasi extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'c201_mutasi';
		$this->TableName = 'c201_mutasi';
		...
		// mutasi_id
		$this->mutasi_id = new DbField('c201_mutasi', 'c201_mutasi', 'x_mutasi_id', 'mutasi_id', 'tx.mutasi_id', 'tx.mutasi_id', 3, 11, -1, FALSE, 'tx.mutasi_id', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tanggal
		$this->tanggal = new DbField('c201_mutasi', 'c201_mutasi', 'x_tanggal', 'tanggal', 'tx.tanggal', CastDateFieldForLike("tx.tanggal", 0, "DB"), 133, 10, 0, FALSE, 'tx.tanggal', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// nourut
		$this->nourut = new DbField('c201_mutasi', 'c201_mutasi', 'x_nourut', 'nourut', 'tx.nourut', 'tx.nourut', 3, 4, -1, FALSE, 'tx.nourut', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// masuk
		$this->masuk = new DbField('c201_mutasi', 'c201_mutasi', 'x_masuk', 'masuk', 'tx.masuk', 'tx.masuk', 5, 14, -1, FALSE, 'tx.masuk', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// keluar
		$this->keluar = new DbField('c201_mutasi', 'c201_mutasi', 'x_keluar', 'keluar', 'tx.keluar', 'tx.keluar', 5, 14, -1, FALSE, 'tx.keluar', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// selisih
		$this->selisih = new DbField('c201_mutasi', 'c201_mutasi', 'x_selisih', 'selisih', 'tx.selisih', 'tx.selisih', 5, 19, -1, FALSE, 'tx.selisih', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// mutasi
		$this->mutasi = new DbField('c201_mutasi', 'c201_mutasi', 'x_mutasi', 'mutasi', '@mutasi := @mutasi + tx.selisih', '@mutasi := @mutasi + tx.selisih', 5, 69, -1, FALSE, '@mutasi := @mutasi + tx.selisih', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// jo_id
		$this->jo_id = new DbField('c201_mutasi', 'c201_mutasi', 'x_jo_id', 'jo_id', 'tx.jo_id', 'tx.jo_id', 3, 11, -1, FALSE, 'tx.jo_id', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// jenis_id
		$this->jenis_id = new DbField('c201_mutasi', 'c201_mutasi', 'x_jenis_id', 'jenis_id', 'tx.jenis_id', 'tx.jenis_id', 3, 11, -1, FALSE, 'tx.jenis_id', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// comment
		$this->comment = new DbField('c201_mutasi', 'c201_mutasi', 'x_comment', 'comment', 'tx.comment', 'tx.comment', 201, 16777215, -1, FALSE, 'tx.comment', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
	...
	{
		return ($this->SqlSelect != "") ? $this->SqlSelect : "SELECT tx.mutasi_id, tx.tanggal, tx.nourut, tx.jo_id, tx.jenis_id, tx.masuk, tx.keluar, tx.selisih, @mutasi := @mutasi + tx.selisih AS mutasi, tx.comment FROM " . $this->getSqlFrom();
	}
	...
	{
		return ($this->SqlOrderBy != "") ? $this->SqlOrderBy : "tx.tanggal, tx.nourut";
	}
	...
	{
		global $Language;
		if ($pageName == "c201_mutasiview.php")
			return $Language->phrase("View");
		elseif ($pageName == "c201_mutasiedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "c201_mutasiadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("c201_mutasiview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("c201_mutasiview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "c201_mutasiadd.php?" . $this->getUrlParm($parm);
		else
			$url = "c201_mutasiadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("c201_mutasiedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("c201_mutasiadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("c201_mutasidelete.php", $this->getUrlParm());
	}
	...
	public function renderListRow()
	{
		...
		$this->jenis_id->ViewValue = FormatNumber($this->jenis_id->ViewValue, 0, -2, -2, -2);
