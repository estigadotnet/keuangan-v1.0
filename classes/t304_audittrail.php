...
class t304_audittrail extends DbTable
{
	...
	public function __construct()
	{
		...
		// datetime
		$this->datetime = new DbField('t304_audittrail', 't304_audittrail', 'x_datetime', 'datetime', '`datetime`', CastDateFieldForLike("`datetime`", 0, "DB"), 135, 19, 0, FALSE, '`datetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
