 ...
 * Page class
 */
class t101_saldoawal_view extends t101_saldoawal
{
	...
	// Page object name
	public $PageObjName = "t101_saldoawal_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "t101_saldoawallist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "t101_saldoawallist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "t101_saldoawallist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
