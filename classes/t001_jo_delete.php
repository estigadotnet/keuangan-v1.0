 ...
 * Page class
 */
class t001_jo_delete extends t001_jo
{
	...
	// Page object name
	public $PageObjName = "t001_jo_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t001_jolist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("t001_jolist.php"); // Return to list
			}
		}
	}
