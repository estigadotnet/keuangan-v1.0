 ...
 * Page class
 */
class t102_mutasi_delete extends t102_mutasi
{
	...
	// Page object name
	public $PageObjName = "t102_mutasi_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t102_mutasilist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("t102_mutasilist.php"); // Return to list
			}
		}
	}
