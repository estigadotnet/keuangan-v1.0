...
$CONFIG = [
	...
	"RANDOM_KEY" => 'SumGy2PbZzviBdrj', // Random key for encryption
	...
	"PROJECT_ID" => "{FBB5EF95-13BB-496B-B131-E8C649D0628A}", // Project ID (GUID)
	...
	"CONNECTION_INFO" => [
		"DB" => ["id" => "DB", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "localhost", "port" => 3307, "user" => "root", "pass" => "admin", "db" => "db_keuangan_1_0"]
	],
	...
	"MAX_FILE_SIZE" => 10000000, // Max file size
