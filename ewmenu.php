...
$topMenu->addMenuItem(1, "mi_t001_jo", $MenuLanguage->MenuPhrase("1", "MenuText"), $MenuRelativePath . "t001_jolist.php", 9, "", AllowListMenu('{FBB5EF95-13BB-496B-B131-E8C649D0628A}t001_jo'), FALSE, FALSE, "", "", TRUE);
$topMenu->addMenuItem(10, "mci_Transaksi", $MenuLanguage->MenuPhrase("10", "MenuText"), "", -1, "", IsLoggedIn(), FALSE, TRUE, "", "", TRUE);
$topMenu->addMenuItem(3, "mi_t102_mutasi", $MenuLanguage->MenuPhrase("3", "MenuText"), $MenuRelativePath . "t102_mutasilist.php", 10, "", AllowListMenu('{FBB5EF95-13BB-496B-B131-E8C649D0628A}t102_mutasi'), FALSE, FALSE, "", "", TRUE);
...
$sideMenu->addMenuItem(1, "mi_t001_jo", $MenuLanguage->MenuPhrase("1", "MenuText"), $MenuRelativePath . "t001_jolist.php", 9, "", AllowListMenu('{FBB5EF95-13BB-496B-B131-E8C649D0628A}t001_jo'), FALSE, FALSE, "", "", TRUE);
$sideMenu->addMenuItem(10, "mci_Transaksi", $MenuLanguage->MenuPhrase("10", "MenuText"), "", -1, "", IsLoggedIn(), FALSE, TRUE, "", "", TRUE);
$sideMenu->addMenuItem(3, "mi_t102_mutasi", $MenuLanguage->MenuPhrase("3", "MenuText"), $MenuRelativePath . "t102_mutasilist.php", 10, "", AllowListMenu('{FBB5EF95-13BB-496B-B131-E8C649D0628A}t102_mutasi'), FALSE, FALSE, "", "", TRUE);
